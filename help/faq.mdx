---
title: "Frequently Asked Questions About Nebula"
sidebarTitle: "FAQ"
description: "Common questions about connecting agents, spending policy, wallet custody, payments, and troubleshooting Nebula."
---
...
<Accordion title="Where are my agent's private keys?">
  Your agent's Stellar private keys are **never exposed to your code, your machine, or the MCP package**. Keys are generated and stored inside the Nebula Hub using [Privy](https://privy.io) custody infrastructure — they live in hardware-secured enclaves and never leave the Hub.
