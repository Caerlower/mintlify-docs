...
description: "Returns the Stellar public key (G…) and network name for the agent's Nebula wallet. Use this address to receive funds or verify your active environment."
---
