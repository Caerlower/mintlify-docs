---
title: "ping — Nebula Health Check and Connectivity Test"
sidebarTitle: "ping"
description: "Verify your agent token is valid and the Nebula Hub is reachable. Takes no parameters and returns an ISO 8601 timestamp on success."
---
