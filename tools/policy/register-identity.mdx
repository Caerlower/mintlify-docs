...
`register_identity` creates a Stellar8004 (ERC-8004 compatible) on-chain identity record for your agent's wallet. The identity is signed via the Nebula Hub using your agent's Privy-managed key. Once registered, your agent has a verifiable, explorer-visible presence on the Stellar network that other agents and gated services can look up to assess trustworthiness.
