---
title: "await_confirmation — Poll Pending Human Approval Requests"
sidebarTitle: "await_confirmation"
description: "Poll a pending human confirmation request (max 25 s per call). Re-call with the same confirmation_id until the decision is approved, rejected, or expired."
---
