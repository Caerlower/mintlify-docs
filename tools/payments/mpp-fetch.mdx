---
title: "mpp_fetch — Fetch an MPP-Gated URL via Active Session"
sidebarTitle: "mpp_fetch"
description: "Commit an off-chain micropayment and fetch an MPP-gated URL in one call. Requires an active session opened with mpp_open_session. No on-chain tx per call."
---
