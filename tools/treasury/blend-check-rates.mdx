---
title: "blend_check_rates — View Current Blend Pool APY"
sidebarTitle: "blend_check_rates"
description: "Returns the current supply APY for Blend DeFi pools where your agent's idle funds earn yield."
---
...
- **Choosing a pool** — if your dashboard policy allows multiple pool targets, compare rates before calling `optimize_treasury`.
